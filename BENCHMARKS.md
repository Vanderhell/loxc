...
benchmarks/plain_sample_text.txt |   30000 |     18646 |   62.2% |    4.62ms |    0.51ms | OK
...
The `demo` module is trained on the bundled sample text corpus. It supports the
symbols and dictionary entries observed in that sample, so files with different
...
- `plain_sample_text.txt`: 30 KB corpus slice to 18 KB encoded, 62.2% ratio.
